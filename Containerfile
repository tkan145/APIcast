FROM registry.access.redhat.com/ubi8/ubi:8.10-1184 AS rpm-builder
...
FROM registry.access.redhat.com/ubi8/ubi:8.10-1184 AS apicast
...
ENV LUA_PATH "/usr/local/share/lua/5.1/?.lua;/usr/local/share/lua/5.1/*/?.lua;/usr/share/lua/5.1/?.lua;/usr/share/lua/5.1/*/?.lua;;"
